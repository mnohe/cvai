...
| ID | Title | Milestone | LLM | Credit |
|---|---|---|---|---|
| [UC-ROLE-001](UC-ROLE-001-quick-analysis.md) | Quick analysis | M3 | Yes | Free (rate-limited) |
...
| ID | Title | Milestone | LLM | Credit |
|---|---|---|---|---|
| [UC-BILLING-001](UC-BILLING-001-purchase-credits.md) | Purchase credits | M1 | No | — |
